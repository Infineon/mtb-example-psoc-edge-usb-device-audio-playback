...
const USB_DEVICE_INFO usb_deviceInfo =
{
    ...
    "USB Audio Playback",         /* ProductName */
    ""                            /* SerialNumber */
};
...
/* Also update MAX_AUDIO_IN_PACKET_SIZE_BYTES and */
/* MAX_AUDIO_OUT_PACKET_SIZE_BYTES accordingly. */
...
{
    {0, AUDIO_OUT_NUM_CHANNELS, AUDIO_OUT_SUB_FRAME_SIZE, AUDIO_OUT_BIT_RESOLUTION, AUDIO_OUT_SAMPLE_FREQ},
};
